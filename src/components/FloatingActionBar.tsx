    ...
    >
      <div className="mx-auto flex max-w-md items-center gap-3">
        ...
        <a
          ...
          className="flex h-12 flex-1 items-center justify-center gap-2 rounded-sm bg-accent-whatsapp px-4 text-xs font-semibold text-white shadow-sm transition-colors hover:bg-accent-whatsapp-hover active:scale-[0.98]"
        >
